...
func assertJenkinsConfig(conf *config, t *testing.T) {
	...
	assert.Equal(t, conf.Jenkins.Jcasc.ConfigurationURL, "https://raw.githubusercontent.com/B2BInternetSolutions/k8s-jcasc-management-go/master/projects/{{ .Base.Namespace }}/jcasc_config.yaml")
